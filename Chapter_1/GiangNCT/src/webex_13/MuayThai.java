...
// 57. Reads in the weight of a Muay Thai kickboxer (in pounds) as a command-line argument and prints their weight class
public class MuayThai {
  ...
  public static void main(String[] args) {
    ...
    if (weight < 112 && weight > 0) {
      ...
      default:
        System.out.println("Super heavyweight");break;
      }
    }
  }
